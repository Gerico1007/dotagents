...
| `audit-exposition/BRIEF.md` | ce que la machine sert au monde — 26 ports, aucun pare-feu | **oui** — `w1J:p1`, ouverte le 2026-08-16 | à jour |
| `audit-exposition/RAPPORT.md` | **sa réponse** : les 26 ports + **7 que le brief n'avait pas comptés** (1716/1717/1718/1721, 4369, 5672, 8787). **Le §2 est tranché SANS tiers ni téléphone** — la machine garde la trace des inconnus : 55 122 échecs SSH de 154 IP publiques (dernier à 19:04), un inconnu sur le VNC 5900 à 19:03:29, 13 sockets de scanners ouvertes sur le 8080 en direct. Aucune connexion SSH **réussie** depuis Internet. Les trois plus graves : **5901** (VNC, 8 caractères, aucune limite de tentatives), **8790** (forest-conductor, `POST /send` dans les tmux, **zéro authentification**), **8828/8768/8830** (191 fichiers + presse-papiers + `DELETE`). Rien n'a été modifié. | **oui** — remis le 2026-08-16 | à jour |
| `phoenix/BRIEF.md` | la reprise de l'atelier musique — opus 013 à 015, la méthode de l'opus 014 | **oui** — `w17:pH`, ouverte le 2026-09-03 | à jour |
| `phoenix/` — ce que la reprise a livré | la critique de Jerry du 20 août est écoutée, mesurée, rattachée à op-014 et **répondue** (voix + note + preuves). Les deux vidéos refusées sont **refaites et défilent**. Son « analyse complète du travail » est livrée. **Cause trouvée** : `jamai-defile.py` renommé `jamai-scroll.py` le 2026-08-15 23 h 16 ; cinq fichiers citaient encore le nom disparu, et le voisin `jamai-score-video.py` fait l'inverse. Corrigé partout. | **oui** — remis le 2026-09-03 | à jour |
